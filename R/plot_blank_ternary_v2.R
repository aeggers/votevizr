...
#' @param padding Amount of space to add around vertices.
#' @param offset Distance from vertices to vertex labels. 
#' @param vertex_labels Labels for vertices, in (lower-left, top, lower-right) order.
#' @param main Label for plot.
#' @param vertex_labels_cex Character expansion for figure labels.
#' 
#' @export
