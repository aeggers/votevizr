...
df <- data.frame("Ranking" = names(brexit_result), 
...
Or a hypothetical positional method where a first-ranking gets 1 point, a last ranking gets 0 points, and a second ranking gets 2/5 of a point, which would produce a near tie between Remain and Deal:  
...
Or an election using the Condorcet method:  
